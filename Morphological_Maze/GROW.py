...
class GROW(gym.Env):
    def __init__(
        ...
        obs_res_resize=8,
        repeat_times=100,
        reward_params=[40, 0, 1, 0.0002, 23],
        visualize=False,
        save_file_name=None,
    ):
        ...
        self.offset_x = 0.0
        self.offset_y = 0.16
        self.add_voxel(-0.06, 0.0, 0.16, 0.16)
    ...
    def reset(self):
        ...
        self.y_init = np.argpartition(-self.x.to_numpy()[:, 1], 2000)[:2000]
...
if __name__ == "__main__":
    ...
    env = GROW(visualize=True, save_file_name="test")
    env.reset()
