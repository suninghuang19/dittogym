...
class SLOT(gym.Env):
    def __init__(
        ...
        self.add_voxel(0.52, 0.162, 0.13, 0.03, is_object=True)
    ...
    def reset(self):
        ...
        self.init_location = np.mean(x_numpy, axis=0)
...
if __name__ == "__main__":
    ...
    env = SLOT(visualize=True, save_file_name="test")
    env.reset()
